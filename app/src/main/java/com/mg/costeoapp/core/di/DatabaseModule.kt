...
object DatabaseModule {
    ...
    fun provideDatabase(@ApplicationContext context: Context): CosteoDatabase =
        Room.databaseBuilder(
            ...
            .addMigrations(CosteoDatabase.MIGRATION_1_2, CosteoDatabase.MIGRATION_2_3, CosteoDatabase.MIGRATION_3_4, CosteoDatabase.MIGRATION_4_5, CosteoDatabase.MIGRATION_5_6, CosteoDatabase.MIGRATION_6_7, CosteoDatabase.MIGRATION_7_8, CosteoDatabase.MIGRATION_8_9, CosteoDatabase.MIGRATION_9_10, CosteoDatabase.MIGRATION_10_11, CosteoDatabase.MIGRATION_11_12)
